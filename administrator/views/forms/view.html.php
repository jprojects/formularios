 ...
 * @since  1.6
 */
class FormulariosViewForms extends JViewLegacy
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		JHtmlSidebar::setAction('index.php?option=com_formularios&view=forms');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`email`' => JText::_('COM_FORMULARIOS_FORMS_EMAIL'),
