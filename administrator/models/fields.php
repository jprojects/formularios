 ...
 * @since  1.6
 */
class FormulariosModelFields extends JModelList
{
/**
	* Constructor.
	*
	...
	*/
	...
	protected function getListQuery()
	{
		...
		$formid = JFactory::getApplication()->input->get('formId', 0);
		...
		$query->from('`#__formularios_fields` AS a');
